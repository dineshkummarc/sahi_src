...
public class BrowserLauncherTest extends TestCase {
    ...
    public void testEscapeForWindows() {
        BrowserLauncher browserLauncher = new BrowserLauncher("C:\\ie.exe", "ie.exe", "");
    ...
    public void testEscapeForNonWindows() {
        BrowserLauncher browserLauncher = new BrowserLauncher("/usr/programs/firefox", "firefox", "");
    ...
    public void ytestFirefoxFirstLaunchAndKill() throws InterruptedException, IOException {
    	...
    	Configuration.init();
    	BrowserLauncher browserLauncher = new BrowserLauncher("C:\\Program Files\\Mozilla Firefox\\firefox.exe", "firefox.exe", "-profile " + pathname + " -no-remote");
